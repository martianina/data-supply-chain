...
import { ProducedValidation } from '../../../_functions/validateProducedCommit';

const ValidationErrorAlert = ({ validation, onProceed }: { validation: ProducedValidation | undefined, onProceed: () => void }) => {
    ...
    return (
        <div>
            <Alert.Root identifier='producedValidationErrors' >
                <Alert.Content
