...
const ItemCard = ({ bomItem }: { bomItem: ExBprBom }) => {
  const router = useRouter()
  const handleClick = () => { 
      router.push(`/production/compounding/${bomItem.bpr.referenceCode}/${bomItem.bom.identifier}?bprBomId=${bomItem.id}&bprId=${bomItem.bprId}`)
  }
  return (
